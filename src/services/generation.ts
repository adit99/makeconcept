...
// API key is read from import.meta.env.VITE_ANTHROPIC_API_KEY — never process.env.

export const CREATION_PROMPT = `You are the app generator for Make.app. Generate a single self-contained HTML file that works as a mobile mini-app.
...
- Off-white background (#F7F7F8), white card surfaces, blue accent (#2563EB) used sparingly
...
export const EDIT_PROMPT = `You are the app generator for Make.app. Update an existing mini-app.
